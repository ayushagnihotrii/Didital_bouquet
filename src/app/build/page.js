...
function BuildContent() {
  ...
  return (
    <div className="min-h-screen bg-cream" style={themeStyle}>
      {/* Header */}
      ...
      {/* Navigation buttons */}
      <div className="fixed bottom-0 left-0 right-0 bg-cream/95 backdrop-blur-sm border-t border-gray-100 p-4 z-30">
